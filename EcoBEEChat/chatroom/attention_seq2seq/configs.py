...
tf.compat.v1.flags.DEFINE_string('data_path_attention_seq2seq',
                           '../dataset/recycle - recycle.csv', 'data path')  # 데이터 위치
tf.compat.v1.flags.DEFINE_string(
    'vocabulary_path_attention_seq2seq', '../attention_seq2seq/dataset/vocabulary.pickle', 'vocabulary path')  # 사전 위치
tf.compat.v1.flags.DEFINE_string(
    'check_point_path_attention_seq2seq', '../attention_seq2seq/dataset/check_point', 'check point path')  # 체크 포인트 위치
tf.compat.v1.flags.DEFINE_string(
    'save_model_path_attention_seq2seq', '../attention_seq2seq/dataset/model', 'save model')  # 모델 저장 경로
tf.compat.v1.flags.DEFINE_integer(
