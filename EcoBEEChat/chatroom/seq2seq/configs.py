...
tf.compat.v1.flags.DEFINE_string(
    'data_path_seq2seq', '../dataset/recycle - recycle.csv', 'data path')  # 데이터 위치
tf.compat.v1.flags.DEFINE_string('vocabulary_path_seq2seq',
                           '../seq2seq/dataset/vocabulary.voc', 'vocabulary path')  # 사전 위치
tf.compat.v1.flags.DEFINE_string('check_point_path_seq2seq',
                           '../seq2seq/dataset/check_point', 'check point path')  # 체크 포인트 위치
